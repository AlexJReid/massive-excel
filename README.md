...
An Excel add-in that streams live market data from the [Massive](https://massive.com) [WebSocket API](https://massive.com/docs/websocket/quickstart) into cells in your workbook.
